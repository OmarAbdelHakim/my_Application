...
import com.example.myapplication.CallBack.MyButtonClickListner;
...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton{
        ...
        public MyButton(Context context, String text,int textSize, int imgResId,  int color, MyButtonClickListner listener) {
            this.text = text;
